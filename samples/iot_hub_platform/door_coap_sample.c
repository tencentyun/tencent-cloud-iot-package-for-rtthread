...
#define COAP_DOOR_THREAD_STACK_SIZE 	4096
...
void printUsage()
{
    HAL_Printf("1. ./door_coap come_home [targetDeviceName]\n");
    HAL_Printf("2. ./door_coap leave_home [targetDeviceName]\n");
}
...
#include <finsh.h>
FINSH_FUNCTION_EXPORT(tc_coap_door_example, startup coap door example);
#endif

#ifdef FINSH_USING_MSH
MSH_CMD_EXPORT(tc_coap_door_example, startup coap door example);
#endif
