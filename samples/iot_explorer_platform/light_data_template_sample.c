...
int tc_data_template_light_example(int argc, char **argv)
{
    rt_err_t result;
    rt_thread_t tid;
    ...
    if (!tid)
    {
        Log_d("no memory for thread: tc_data_template_light_example");
        return -1;
    }
    ...
    result = rt_thread_init(tid,
                            "data_template",
                            (void *)data_template_light_thread, NULL, // fun, parameter
